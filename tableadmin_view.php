    ...
    <div class="row">
      <div class="col-12">
        ...
        <div class="card-footer">
          <div class="btn-group">
            <form action="action_approve.php" id="lulus" method="POST" class="action-form-child" onsubmit="return confirm('Adakah anda pasti untuk meluluskan permohonan ini?');">
                <button type="submit" name="activity_no" id="lulus" value="<?php echo $d['activity_no'] ?>" href="action_approve.php" class="btn btn-sm btn-success">LULUS</button>
            </form>
            </div>  
            <div class="btn-group">
              <form action="action_reject.php" method="POST" class="action-form-child" onsubmit="return confirm('Adakah anda pasti untuk menggagalkan permohonan ini?');">
                  <button type="submit" name="activity_no" value="<?php echo $d['activity_no'] ?>" href="action_reject.php" class="btn btn-sm btn-danger">GAGAL</button>
              </form>
            </div>      
        </div>
        </div>
