...
$sql = "UPDATE activity SET application_status='REJECTED' WHERE activity_no='$activity_no';";
...
if (($sql)) {
    ...
    $body = "Test. Permohonan anda telah ditolak." ."<br>"."<br>"."<br>". "Email ini dijana secara automatik oleh sistem PERMATA dan tidak perlu dibalas.";
...
header('location:admin_rejected.php');
