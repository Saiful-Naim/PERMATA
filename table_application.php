                ...
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-hover">
                    ...
                    <?php
                      ...
                      where a.application_status = 'DIPROSES' OR a.application_status = 'APPROVED' OR a.application_status = 'REJECTED';";
                  ...
                  <tr>
                      ...
                      <td><span class="badge badge-primary"><?php echo $d['application_status']; ?></span></td>
                      <td>
                          <div class="btn-group">
                            <button type="submit" onclick="window.location.href='tableadmin_view.php?activity_no=<?php echo $d['activity_no']; ?>'" class="btn btn-primary btnn-block btn-sm fas fa-eye"></button> 
