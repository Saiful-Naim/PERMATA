          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="admin_proses.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                ...
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-hover">
                    ...
                    <?php
                      ...
                      where a.application_status = 'DIPROSES';";
                  ...
                  <tr>
                      ...
                      <td><span class="badge badge-warning"><?php echo $d['application_status']; ?></span></td>
                      <td>
                          <div class="btn-group">
