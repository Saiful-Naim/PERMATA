        ...
        <div class="row">
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                ...
                <?php
                  $conn = mysqli_connect("localhost", "root", "", "permatadb2");
                  $sql = "SELECT * FROM activity WHERE application_status = 'DIPROSES' OR application_status='APPROVED' OR application_status='REJECTED'";
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <a href="admin_proses.php"><span class="info-box-text">Permohonan Diproses</span></a> 
                <span class="info-box-number">
                <?php
                  $conn = mysqli_connect("localhost", "root", "", "permatadb2");
                  $sql = "SELECT * FROM activity WHERE application_status = 'DIPROSES'";
                  $qry = mysqli_query($conn, $sql);
                  $result = $conn->query($sql);
                  $row = mysqli_num_rows($qry);
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <?php
                  $conn = mysqli_connect("localhost", "root", "", "permatadb2");
                  $sql = "SELECT * FROM activity WHERE application_status = 'APPROVED'";
                  $qry = mysqli_query($conn, $sql);
                  $result = $conn->query($sql);
                  $row = mysqli_num_rows($qry);
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <?php
                  $conn = mysqli_connect("localhost", "root", "", "permatadb2");
                  $sql = "SELECT * FROM activity WHERE application_status = 'REJECTED'";
                  $qry = mysqli_query($conn, $sql);
                  $result = $conn->query($sql);
                  $row = mysqli_num_rows($qry);
