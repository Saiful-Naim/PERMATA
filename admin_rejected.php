          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="admin_rejected.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <tr>
                      ...
                      <td><span class="badge badge-danger"><?php echo $d['application_status']; ?></span></td>
                      <td>
                          <div class="btn-group">
                            <!-- <form action="tableadmin_view.php" method="POST" class="action-form-child"> -->
                            <button type="submit" onclick="window.location.href='tableadmin_view_reject.php?activity_no=<?php echo $d['activity_no']; ?>'" class="btn btn-primary btnn-block btn-sm fas fa-eye"></button>     
